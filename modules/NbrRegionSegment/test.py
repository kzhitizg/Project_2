...
img = cv.imread("D:/Project 2/Project_2/Dataset/" + "Case_3_A12-37374-17669" + ".jpg")
...
for i in range(10, 50, 5):
    r1, r2 = _RegionExtractWrapper(img, lbp, i, 5.12561905e-01, 1.17403947e-01, 8.39755087e-01,)
